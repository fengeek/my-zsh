...
# User ----------------------------------------------------------------------- #
POWERLEVEL9K_USER_VISUAL_IDENTIFIER_EXPANSION=$'\uF007' # 
POWERLEVEL9K_USER_DEFAULT_VISUAL_IDENTIFIER_COLOR=$COLOR_PRIMARY
POWERLEVEL9K_USER_DEFAULT_BACKGROUND=$COLOR_BLACK
# Host ----------------------------------------------------------------------- #
POWERLEVEL9K_HOST_VISUAL_IDENTIFIER_EXPANSION=$'\uF823' # 
POWERLEVEL9K_HOST_FOREGROUND=$COLOR_SECONDARY
POWERLEVEL9K_HOST_BACKGROUND=$COLOR_BLACK
# Custom hardware ------------------------------------------------------------ #
